...
function PromotionDisclosure() {
  return (
    <>
      ...
      >
        <path
          d="M0.5 10.1154L25.5 0.5L21.6538 21.6538L8.25 14.3423L23.5769 2.42308L5.87308 13.0442L0.5 10.1154ZM8.19231 25.5V16.3962L13.9615 19.7308L8.19231 25.5Z"
          fill="#A0A3BD"
        />
      </svg>
    </>
...
function ProjectWallets() {
  return (
    <>
      ...
      >
        <path
          d="M14.3949 14.85C14.2131 14.85 14.0388 14.9445 13.9102 15.1127C13.7817 15.2809 13.7095 15.509 13.7095 15.7469C13.7095 15.9847 13.7817 16.2129 13.9102 16.3811C14.0388 16.5493 14.2131 16.6437 14.3949 16.6437H16.8626C17.0444 16.6437 17.2188 16.5493 17.3473 16.3811C17.4759 16.2129 17.5481 15.9847 17.5481 15.7469C17.5481 15.509 17.4759 15.2809 17.3473 15.1127C17.2188 14.9445 17.0444 14.85 16.8626 14.85H14.3949ZM0 3.37V21.8456C0 23.035 0.361096 24.1756 1.00385 25.0166C1.64661 25.8575 2.51837 26.33 3.42737 26.33H16.8626C17.7716 26.33 18.6434 25.8575 19.2861 25.0166C19.9289 24.1756 20.29 23.035 20.29 21.8456V9.28937C20.29 8.25566 20.017 7.25369 19.5174 6.45291C19.0178 5.65213 18.3222 5.10169 17.5481 4.89469V3.54937C17.5481 2.74063 17.3026 1.96501 16.8655 1.39314C16.4284 0.821273 15.8356 0.5 15.2175 0.5H2.33061C1.73619 0.499934 1.16422 0.797041 0.731699 1.33054C0.299179 1.86404 0.0388043 2.59361 0.00383863 3.37H0ZM16.1772 3.54937V4.805H2.33061C2.07609 4.805 1.832 4.67271 1.65202 4.43724C1.47205 4.20176 1.37095 3.88239 1.37095 3.54937C1.37095 3.21636 1.47205 2.89699 1.65202 2.66151C1.832 2.42604 2.07609 2.29375 2.33061 2.29375H15.2175C15.7478 2.29375 16.1772 2.85627 16.1772 3.54937ZM1.37095 6.59875H16.8626C17.408 6.59875 17.9311 6.88223 18.3167 7.38682C18.7024 7.89141 18.9191 8.57578 18.9191 9.28937V21.8456C18.9191 22.5592 18.7024 23.2436 18.3167 23.7482C17.9311 24.2528 17.408 24.5362 16.8626 24.5362H3.42737C2.88197 24.5362 2.35891 24.2528 1.97326 23.7482C1.5876 23.2436 1.37095 22.5592 1.37095 21.8456V6.59875Z"
          fill="#A0A3BD"
        />
      </svg>
    </>
...
function HorizontalLinearStepper({ currentStep, setCurrentStep }: any) {
  return (
    <Box sx={{ width: '100%' }}>
...
function S8() {
  return (
    <>
      ...
      <p>
        * We need developers to submit updates to our project to more accurately
        represent your “Health” rating. Upon submission, the updates will be
        verified and reflected within your project’s “Health” rating
        immediately.
      </p>
      ...
      <p>
        * We need the developers to disclose the marketing they’ve paid for.
        This is especially true if the project is paying for promotion on social
        media - Twitter, TikTok, YouTube, Instagram, Weibo, etc. The amount
        spent, to whom it was given, and on what metrics. We do this to protect
        the community from serial scammers.{' '}
      </p>
      ...
      >
        ...
        <Button variant="contained" size="large" sx={{ paddingX: '7%' }}>
          Next
        </Button>
      </Box>
    </>
        ...
        <Grid item xs={12} sm={12} columns={{ xs: 4, md: 12 }}>
          <Box className={pageStyles.team}>
            ...
            <span>
              ...
              >
                <path
                  d="M10.5 5C10.5 5.26522 10.3946 5.51957 10.2071 5.70711C10.0196 5.89464 9.76522 6 9.5 6H6.5V9C6.5 9.26522 6.39464 9.51957 6.20711 9.70711C6.01957 9.89464 5.76522 10 5.5 10C5.23478 10 4.98043 9.89464 4.79289 9.70711C4.60536 9.51957 4.5 9.26522 4.5 9V6H1.5C1.23478 6 0.98043 5.89464 0.792894 5.70711C0.605357 5.51957 0.5 5.26522 0.5 5C0.5 4.73478 0.605357 4.48043 0.792894 4.29289C0.98043 4.10536 1.23478 4 1.5 4H4.5V1C4.5 0.734783 4.60536 0.48043 4.79289 0.292893C4.98043 0.105357 5.23478 0 5.5 0C5.76522 0 6.01957 0.105357 6.20711 0.292893C6.39464 0.48043 6.5 0.734783 6.5 1V4H9.5C9.76522 4 10.0196 4.10536 10.2071 4.29289C10.3946 4.48043 10.5 4.73478 10.5 5Z"
                  fill="white"
                  fillOpacity="0.6"
                />
              </svg>{' '}
        ...
        <Grid item xs={12} sm={12}>
          <FormControl fullWidth>
            ...
            <IconTextField
              ...
              iconEnd={
                <VolumeUpOutlinedIcon sx={{ color: '#A0A3BD', fontSize: 20 }} />
              }
            />
          </FormControl>
        </Grid>
